  ...
  module V1
    class WorkLocationsController < ApplicationController
      ...
      def create
        ...
        if profile.nil?
          render json: { errors: "Profile not found. Please create a profile first." }, status: :unprocessable_content
          return
        end
        ...
        if work_location.save
          ...
          render json: { errors: work_location.errors.full_messages }, status: :unprocessable_content
        end
      end
